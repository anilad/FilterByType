...
Integer--> if the integer is greater than or equal to 100 print "That's a big number" else print "That's a small number"
...
List --> if the length of the list greater than or equal to 10, print "Big List!" else print "Short list."
'''
def type(value):
